...
defined('EPAYCO_TEST_MODE') || define('EPAYCO_TEST_MODE', true);
defined('EPAYCO_RESPONSE_BASE_URL') || define('EPAYCO_RESPONSE_BASE_URL', 'http://192.168.1.6/appdomicilios_api/api');
defined('EPAYCO_PUBLIC_CONFIRMATION_BASE_URL') || define('EPAYCO_PUBLIC_CONFIRMATION_BASE_URL', '');
defined('EPAYCO_CHECKOUT_PAGE_BASE_URL') || define('EPAYCO_CHECKOUT_PAGE_BASE_URL', 'http://192.168.1.6/appdomicilios_api/api');

defined('EPAYCO_P_CUST_ID_CLIENTE') || define('EPAYCO_P_CUST_ID_CLIENTE', '');
defined('EPAYCO_P_KEY') || define('EPAYCO_P_KEY', '');
defined('EPAYCO_PUBLIC_KEY') || define('EPAYCO_PUBLIC_KEY', '');
defined('EPAYCO_PRIVATE_KEY') || define('EPAYCO_PRIVATE_KEY', '');
